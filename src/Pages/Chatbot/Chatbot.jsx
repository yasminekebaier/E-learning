  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-r from-#174090-500 to-#174090-600 text-white rounded-full shadow-2xl hover:shadow-#174090-500/25 transition-all duration-300 z-50 flex items-center justify-center group"
        style={{
          boxShadow: isOpen 
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-#174090-500 to-#174090-600 text-white p-4 flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-#174090-100">
            ...
            <div className={`p-4 border-t ${
              ...
              <div className="flex space-x-3">
                <input
                  ...
                  className={`flex-1 px-4 py-3 rounded-full border-2 transition-all duration-200 focus:ring-2 focus:ring-#174090-500 focus:border-transparent ${
                    settings.theme === 'dark'
                ...
                <motion.button
                  ...
                  className="w-12 h-12 bg-gradient-to-r from-#174090-500 to-#174090-600 text-white rounded-full hover:from-#174090-600 hover:to-#174090-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg"
                >
