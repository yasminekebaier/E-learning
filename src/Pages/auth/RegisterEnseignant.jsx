...
const specialties = [
  ...
  "DIGITALISATION_ET_TECHNOLOGIES",
  "SECURITE_ET_PREVENTION",
  "ENVIRONNEMENT_ET_RSE",
];
      ...
      >
        ...
        >
          ...
          <Typography variant="h5" mb={3}>
            Notre objectif est d'aider chaque formateur à accompagner ses
            collaborateurs dans leur apprentissage.
          </Typography>
          <Typography
            variant="subtitle1"
            color="#174090"
          ...
          {["Des outils avancés", "Suivi personnalisé des collaborateurs"].map(
            (text, index) => (
              <Box key={index} display="flex" alignItems="center" mb={1}>
                <CheckCircleIcon
                  sx={{ color: "#52307c", mr: 1, fontSize: 20 }}
                />
          ...
          <Box mt={7} p={2} bgcolor="#e3f2fd" borderRadius="10px" width="55%">
            <Typography variant="body2" fontWeight="bold" color="#174090">
              Cette inscription est préliminaire et sera approuvée par un
              administrateur par courriel.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid
          ...
          xs={12}
          md={7}
          sx={{ backgroundColor: "#f6f9faff", p: 4, width: "60%" }}
        >
          <Paper
            elevation={4}
            sx={{ p: 4, borderRadius: "16px", backgroundColor: "#ffffff" }}
          >
            <Stepper
            ...
            {activeStep === 1 && (
              <>
                ...
                <Box sx={{ p: 2 }}>
                  <Typography>
                    <strong>Nom et prénom:</strong> {formData.fullName}
                  </Typography>
                  {/* <Typography><strong>Matricule:</strong> {formData.matricule}</Typography> */}
                  <Typography>
                    <strong>Numéro de téléphone:</strong> {formData.phone}
                  </Typography>
                  <Typography>
                    <strong>Email académique:</strong> {formData.email}
                  </Typography>
                  <Typography>
